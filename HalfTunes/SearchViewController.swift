...
//            if let trackIndex = trackIndexForDownloadTask(downloadTask: downloadTask){
//                let trackCell = tableView.cellForRow(at: IndexPath(row: trackIndex, section: 0)) as? TrackCell
//                DispatchQueue.main.async{
//                    trackCell?.progressView.progress = (download?.progress)!
//                    trackCell?.progressLabel.text = String(format: "%.1f%% of %@", (download?.progress)! * 100, SIZE_MAX)
//                }
//                
//            }
//     Progress }
